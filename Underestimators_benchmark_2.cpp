...
double fx0(double x1, double x2) {
    ...
    //f13 f = pow((x1 + 10 * x2), 2) + 5 * pow((x3 - x4), 2) + pow((x2 - 2 * x3), 4) + 10 * pow((x1 - x4), 4);
    //f14 f = pow((2 * x1 + x2 - 3), 2) + pow((x1 * x2 - 1), 2);
    //f15 f = 4 * (pow(x1, 2)) - 2.1 * (pow(x1, 4)) + (1 / 3) * (pow(x1, 6)) + x1 * x2 - 4 * (pow(x2, 2)) + 4 * (pow(x2, 4));
    //f17 f = (4 * pow(x1, 2) - (2.1) * pow(x1, 4) + (1 / 6) * pow(x1, 6) + x1 * x2 - 4 * pow(x2, 2) + 4 * pow(x2, 4)) + (4 * pow(x2, 2) - (2.1) * pow(x2, 4) + (1 / 6) * pow(x2, 6) + x2 * x3 - 4 * pow(x3, 2) + 4 * pow(x3, 4));
    //f18 f = pow((x1 - 1), 2) + pow((x2 - 1), 2) + pow((x1 + 2 * x2 - 3), 2) + pow((x1 + 2 * x2 - 3), 4);
    //f19 f= (pow(x1 , 2) - 0.1 * cos(5 * pii * x1)) + (pow(x2 , 2) - 0.1 * cos(5 * pii * x2));
    //f1p f = (cos(2 * x[1] + 1) + 2 * cos(3 * x[1] + 1) + 3 * cos(4 * x[1] + 1) + 4 * cos(5 * x[1] + 1) + 5 * cos(6 * x[1] + 1)) * (cos(2 * x[2] + 1) + 2 * cos(3 * x[2] + 1) + 3 * cos(4 * x[2] + 1) + 4 * cos(5 * x[2] + 1) + 5 * cos(6 * x[2] + 1));
    //f2p f = 1 + pow(sin(x[1]), 2) + pow(sin(x[2]), 2) - 0.1 * exp(-pow(x[1], 2) - pow(x[2], 2));
    //f3p f = 0.5 + (sin(pow(x[1], 2) - pow(x[2], 2)) - 0.5) / pow((1 + 0.001 * (pow(x[1], 2) + pow(x[2], 2))), 2);
    //f4p f = -1 / (pow((x[1] - 4), 2) + pow((x[2] - 4), 2) + 0.1) - 1 / (pow((x[1] - 1), 2) + pow((x[2] - 1), 2) + 0.2) - 1 / (pow((x[1] - 8), 2) + pow((x[2] - 8), 2) + 0.2);
